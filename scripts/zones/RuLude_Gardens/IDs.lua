...
zones[xi.zone.RULUDE_GARDENS] =
{
    text =
    {
        ...
        YOU_HAND_THE_THREE_SLIVERS       = 13758, -- You hand the three crystal slivers to Esha'ntarl.
        ITEM_NOT_WEAPON_MAGIAN           = 14513, -- As I advised you previously, my sole specialty is weapons. I have not the moogle magic at my disposal to augment items of this variety, kupo...
